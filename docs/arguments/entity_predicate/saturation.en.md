...
This [entity predicate](...md) tests entity's saturation. It accepts a floating-point number range, and supports inversion.Similar to [`food`](../food.md), only players can be selected when this parameter is added.
