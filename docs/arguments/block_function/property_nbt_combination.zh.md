...
本页面会详细讲述将基础[方块函数](index.md)、属性和 NBT 组合的语法。
...
和方块谓词类似，当方块函数是[简单方块函数](../simple.md)时，其解析时会完全确定属性函数中的属性以及值，当属性函数中有无效的属性或值时，解析失败。
...
- 方块谓词中的[属性 NBT 组合](../../block_predicate/property_nbt_combination.md)