...
此[方块函数](index.md)简单地产生指定方块状态属性的方块。

## 语法

`[@]<方块 ID>[方块状态属性]`

其中方块状态属性的语法请参见[属性方块函数](property_names.zh.md)。不同的是，和简单方块谓词一样，方块状态属性的名称和值的可接受值都已确定，遇到未知的方块状态属性名称或值时，会直接导致解析错误。
...
- [简单方块谓词](../block_predicate/simple.md)