...
!!! note
    The function is not used to find and replace some contents in the string. To find and replace in the string, please use [`string-replace()` function](string-replace.md) or [`regex-replace()` function](regex-replace.md).
