...
本页面会详细讲述将基础[方块谓词](index.md)、属性和 NBT 组合的语法。
...
当方块谓词是[简单方块谓词](simple.md)时，其支持的属性以及值都是完全确定的，因此解析时会完全确定属性谓词中的属性以及值。在这种情况下，当属性谓词中有无效的属性或值时，解析失败。
...
- 方块函数中的[属性 NBT 组合](../block_function/property_nbt_combination.md)