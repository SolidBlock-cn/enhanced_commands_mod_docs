...
关键字参数继承 [`/setblocks`](setblocks.md) 的所有关键字参数，外加 `interval` 和 `thickness`。

## 参数

### `<曲线>`

需要绘制的[曲线](../arguments/curve/index.md)。

### `<方块>`

需要在此曲线上使用的[方块函数](../arguments/block_function/index.md)。
