...
The [command](...md) can be used to view and set moon phase, and execute commands under a condition related to moon phase. An alias of this command is `/jadeplate`.
